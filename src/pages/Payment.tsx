...
const PaymentPage = () => {
  ...
  // Main Table Data
  const tableData = [
    { id: 1, type: "Slack", code: "SDFE234", users: ["RK"], file: "document_file_name.pdf", label: "AWS paymnet" },
    { id: 2, type: "Slack", code: null, users: ["VY"], file: "document_file_name.pdf", label: "Open AI Cost" },
    { id: 3, type: "Slack", code: null, users: ["SA", "AL", "RK", "VR", "+3"], file: "document_file_name.pdf", label: "AWS paymnet" },
    { id: 4, type: "Slack", code: null, users: ["VP"], file: "document_file_name.pdf", label: "Open AI Cost" },
    { id: 5, type: "Slack", code: null, users: ["SA"], file: "document_file_name.pdf", label: "AWS paymnet" },
    { id: 6, type: "Slack", code: null, users: ["RK"], file: "document_file_name.pdf", label: "Open AI Cost" },
  ];
  ...
  return (
    <div className="payment-page">
      ...
      <div className="transaction-tabs">
        <div className="tab active">Transaction <span className="tab-count">05</span></div>
      </div>
